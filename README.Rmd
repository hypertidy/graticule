...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/mdsumner/graticule.svg?branch=master)](https://travis-ci.org/mdsumner/graticule)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/mdsumner/graticule?branch=master&svg=true)](https://ci.appveyor.com/project/mdsumner/graticule)
[![Codecov test coverage](https://codecov.io/gh/mdsumner/graticule/branch/master/graph/badge.svg)](https://codecov.io/gh/mdsumner/graticule?branch=master)
...
---
 ...
 Please note that the 'graticule' project is released with a
  [Contributor Code of Conduct](https://github.com/mdsumner/graticule/blob/master/CODE_OF_CONDUCT.md).
