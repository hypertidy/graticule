...
output:
  rmarkdown::html_vignette:
    ...
    fig_height: 9
vignette: >
  %\VignetteIndexEntry{auto Graticule}
...
plot(pmap, add = TRUE)
## the lines are a SpatialLinesDataFrame
plot(graticule:::auto_graticule(crop(spex::spex(pmap), grat), nlevels = 7), add = TRUE)
par(op)
...
plot(ice, axes = FALSE)
plot(graticule:::auto_graticule(ice), add = TRUE)
